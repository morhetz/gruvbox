...
if [ "${TERM%%-*}" = "screen" ]; then
	if [ -n "$TMUX" ]; then
		...
		echo -ne "\ePtmux;\e\e]4;241;rgb:66/5c/54\a\e\\"
		echo -ne "\ePtmux;\e\e]4;243;rgb:7c/6f/64\a\e\\"
		...
		echo -ne "\ePtmux;\e\e]4;248;rgb:bd/ae/93\a\e\\"
		echo -ne "\ePtmux;\e\e]4;246;rgb:a8/99/84\a\e\\"

		echo -ne "\ePtmux;\e\e]4;167;rgb:fb/49/34\a\e\\"
		echo -ne "\ePtmux;\e\e]4;142;rgb:b8/bb/26\a\e\\"
		echo -ne "\ePtmux;\e\e]4;214;rgb:fa/bd/2f\a\e\\"
		echo -ne "\ePtmux;\e\e]4;109;rgb:83/a5/98\a\e\\"
		echo -ne "\ePtmux;\e\e]4;175;rgb:d3/86/9b\a\e\\"
		echo -ne "\ePtmux;\e\e]4;108;rgb:8e/c0/7c\a\e\\"
		echo -ne "\ePtmux;\e\e]4;208;rgb:fe/80/19\a\e\\"

		echo -ne "\ePtmux;\e\e]4;88;rgb:9d/00/06\a\e\\"
		echo -ne "\ePtmux;\e\e]4;100;rgb:79/74/0e\a\e\\"
		echo -ne "\ePtmux;\e\e]4;136;rgb:b5/76/14\a\e\\"
		echo -ne "\ePtmux;\e\e]4;24;rgb:07/66/78\a\e\\"
		echo -ne "\ePtmux;\e\e]4;96;rgb:8f/3f/71\a\e\\"
