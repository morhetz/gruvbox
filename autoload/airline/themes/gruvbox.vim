...
function! airline#themes#gruvbox#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['LineNr', 'bg'], ['StatusLineNC', 'bg'])
  ...
  let s:I1 = airline#themes#get_highlight2(['LineNr', 'bg'], ['Identifier', 'fg'])
  let s:I2 = s:N2
  let s:I3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['Pmenu', 'bg'])
  ...
  let s:R1 = airline#themes#get_highlight2(['LineNr', 'bg'], ['Structure', 'fg'])
  let s:R2 = s:I2
  let s:R3 = s:I3
  ...
  let s:V1 = airline#themes#get_highlight2(['LineNr', 'bg'], ['Question', 'fg'])
  let s:V2 = s:N2
  let s:V3 = airline#themes#get_highlight2(['LineNr', 'bg'], ['TabLine', 'fg'])
  ...
  let s:TF = airline#themes#get_highlight2(['LineNr', 'bg'], ['LineNr', 'bg'])
